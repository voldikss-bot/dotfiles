...
let s:p.normal.left = [ ['#ffffff', '#5f00af', 'bold'], ['#ffffff', '#875fd7'] ]
...
let s:p.insert.left = [ ['#ffffff', '#005fff', 'bold'], ['#ffffff', '#00afff'] ]
...
let s:p.tabline.left = [ [ '#ffffff', '#875fd7' ] ]
let s:p.tabline.tabsel = [ [ '#ffffff', '#5f00af' ] ]
let s:p.tabline.middle = [ [ '#121212', '#ffffff' ] ]
let s:p.tabline.right = [ [ '#ffffff', '#5f00af' ] ]
